...
namespace MageJ\BrandCarousel\Service;
...
class ImageService
{
     ...
     *
     * @param \Magento\Framework\DataObject $object
     * @return \MageJ\BrandCarousel\Model\Brand\Image
    ...
    public function getImageUrl(string $imageName, string $imageType = null): string
    {
        ...
        if ($imageType) {
            ...
            /** @var Store $store */
            $store = $this->storeManager->getStore();
            $image = $store->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . "MageJ/brand/{$imageType}/{$imageName}";
        }
