<?php
namespace MageJ\BrandCarousel\Ui\Component\Listing\Column;
...
{
    /** Url path */
    public const URL_PATH_EDIT = 'brandcarousel/index/add';
    public const URL_PATH_DELETE = 'brandcarousel/index/delete';
