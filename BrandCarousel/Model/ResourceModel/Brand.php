...
class Brand extends AbstractDb
{
    ...
    {
        $this->_init('MageJ_brand_slider', 'brand_id');
    }
     ...
     * Load an object
     *
     * @param \MageJ\BrandCarousel\Model\Brand|AbstractModel $object
     * @param mixed $value
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                ['cbs' => $this->getTable('MageJ_brand_store')],
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select = $connection->select()
            ->from(['cbs' => $this->getTable('MageJ_brand_store')], 'store_id')
            ->join(
